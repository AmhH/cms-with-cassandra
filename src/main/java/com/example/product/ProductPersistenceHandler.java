...
public class ProductPersistenceHandler {
    ...
    /**
     * Creates a new com.example.product
     * if category,brand,productId is not unique then values of the existing com.example.product
    ...
    public void insertProducts(Product product){
        ...
        // add all attributes in com.example.product attriute set to insert into()
    ...
    /**
     *  Returns the com.example.product object made by transforming the row object returned by driver
    ...
    */
    private Product getProductFromRow(Row row){
        ...
        if(row != null) {
            ...
            // list contains only those columns for which com.example.product ahs data
