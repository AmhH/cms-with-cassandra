 ...
 *
 * When we want to do db operations involving both com.example.listing and com.example.product,
...
public class CommonPersistenceHandler {
    ...
    /**
     *Executes a logged batch to update the title in the input com.example.listing and com.example.product data
     *
     ...
     * in the com.example.listing object
     *
     * @param listing
    ...
    /**
     * Returns list of update statements for every attribute other than the primary keys
     * in the com.example.product object
     *
     * @param product
     * @return List<Statement> - list of executable queries
     */
    ...
    /**
     * Checks whether attributeName is a part of primary key of com.example.listing
     * @param attributeName
