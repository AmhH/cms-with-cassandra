...
import com.example.product.ProductPersistenceHandler;

import java.util.List;
import java.util.Map;

import static com.example.common.dto.AttributeNames.*;
import static com.example.common.dto.AttributeNames.LENGTH;
import static com.example.common.dto.AttributeNames.TITLE;

/**
 * You can run the main() method from IDE
 * Creates rows for com.example.product - Used in slide example
